        ...
        <div class=" product_data">
            <div class="">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <h2 class="mb-0 text-danger font6">
                            {{ $products->name }}
                        ...
                        <hr>
                        <label class="me-3 font2">Original Price : <s>$ {{ $products->original_price }}</s></label>
                        <label class="fw-bold font2">Selling Price : $ {{ $products->selling_price }}</label>
                        ...
                        <div class="row-mt-2">
                            <div class="col-md-2">
                                ...
                                <label for="Quantity font2">Quantity</label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <button type="button" class="btn btn-danger font5" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            Rate this product
                        </button>
                        <a href="{{ url('add-review/'.$products->slug.'/userreview') }}" class="btn btn-danger font5" >
                            Write a review
                        </a>
                    </div>
                    <div class="col-md-8">
